...
@section('content')
<nav class="navbar fixed-top navbar-expand-lg navbar-light py-24 bg-white">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mx-auto mb-4 mb-lg-0">
                <li class="nav-item">
                    <a class="navlink-scrolled" aria-current="page" href="#jadwal">Jadwal</a>
                </li>
                <li class="nav-item">
                    <a class="navlink-scrolled" href="#alur">Alur</a>
                </li>
                <li class="nav-item">
                    <a class="navlink-scrolled" href="#sop">SOP</a>
                </li>
                <li class="nav-item">
                    <a class="navlink-scrolled" href="#faq">FAQ</a>
                </li>
                <li class="nav-item">
                    <a class="navlink-scrolled" href="#contact">Contact</a>
                </li>
            </ul>
            <div style="width: 205px; text-align: end" class="my-4 my-lg-0">
                <a href="" class="profile">{{ auth()->user()->name }}</a>
            </div>
        </div>
    </div>
</nav>
                        ...
                        <div class="input mb-3">
                            ...
                            <div id="tanggal-container" class="mb-3">
                                <div id="tanggal" class="field-input" style="margin-bottom: 8px">
                                    ...
                                    <div class="time-selector row gx-1">
                                        <div class="col-12 col-sm-4">
                                            <p class="mb-2">
                                                <label for="tanggal1">Tanggal Mulai</label>
                                            </p>
                                            <input type="text" name="tanggal.1" class="input-custom datepicker mb-2" id="date1" placeholder="Pilih Tanggal" />
                                        </div>
                                        <div class="col-4">
                                            <p class="mb-2">
                                            ...
                                            <div class="select">
                                                <select class="input-custom start-time" name="jammulai.1" id="start-time" required>
                                        ...
                                        <div class="col-4">
                                            ...
                                            <div class="select">
                                                <select class="input-custom end-time" name="jamselesai.1" id="end-time">
                                                    <option value="" disabled selected hidden>
                                                        Pilih jam selesai
                                                    </option>
                                                    <option value="7:00 AM">7:00 AM</option>
...
<script>
    $(document).ready(function() {
        ...
        var inputCount = 1; // current number of input fields
        ...
        $(addButton).click(function() {
            if (inputCount < maxInputs) {
                ...
                <div class="jh-input">
                                        <p class="mb-2">
                                            <label for="">Pilih Jadwal ${inputCount}</label>
                                        </p>
                                    ...
                                    <div class="time-selector row gx-1">
                                        <div class="col-12 col-sm-4">
                                            <p class="mb-2">
                                                <label for="tanggal.${inputCount}">Tanggal Mulai</label>
                                            </p>
                                            <input type="text" name="tanggal.${inputCount}" class="input-custom datepicker mb-2" id="date${inputCount}" placeholder="Pilih Tanggal" />
                                        </div>
                                        <div class="col-4">
                                            <p class="mb-2">
                                                <label for="jammulai.${inputCount}">Jam Mulai</label>
                                            </p>
                                            <div class="select">
                                                <select class="input-custom start-time" name="jammulai.${inputCount}" id="start-time${inputCount}" required>
                                                    <option value="" disabled selected hidden>
                                                        Pilih jam mulai
                                                    </option>
                                                    <option value="7:00 AM">7:00 AM</option>
                                        ...
                                        <div class="col-4">
                                            <p class="mb-2">
                                                <label for="jamselesai.${inputCount}">Selesai</label>
                                            </p>
                                            <div class="select">
                                                <select class="input-custom end-time" name="end-time.${inputCount}" id="end-time${inputCount}">
                                                    <option value="" disabled selected hidden>
                                                        Pilih jam selesai
                                                    </option>
                                                    <option value="7:00 AM">7:00 AM</option>
        ...
        $(document).on("click", ".remove-input", function(e) {
            ...
            inputCount--; // decrement input field count
        });
    });
</script>
<script>
